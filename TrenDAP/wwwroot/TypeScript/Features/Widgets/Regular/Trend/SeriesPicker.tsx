...
export default function SeriesPicker(props: { Index: number, Type: DataSourceTypes.DataSourceType, Series: TrenDAP.iTrendSeries, Data: TrenDAP.iDataSetReturnType, Widget: Trend, Callback: () => void }){
