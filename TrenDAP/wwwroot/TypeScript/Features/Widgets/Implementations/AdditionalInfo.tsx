...
export default function AdditionalInfo(props: { Index: number, Data: DataSetTypes.IDataSetData }) {
    return (
        <div className="dropdown">
            ...
            <div className="dropdown-menu" aria-labelledby={"dropdownMenuButton" + props.Index}>
                <div className="dropdown-item">Meter: {props.Data?.ParentName}</div>
                <div className="dropdown-item">Asset: {props.Data?.ParentName}</div>
                ...
                <div className="dropdown-item">Unit: {props.Data?.Unit}</div>
                <div className="dropdown-item">Longitude: {props.Data?.Longitude}</div>
                <div className="dropdown-item">Latitude: {props.Data?.Latitude}</div>
