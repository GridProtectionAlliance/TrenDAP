...
export default function TextJSX(props: TrenDAP.iTemplatableWidget<TrenDAP.iTemplatableText>) {
    ...
    return (
        <div className="card" style={{ width: props.Width, height: props.Height }}>
            ...
            <Widget {...props} Record={record} Toggle={toggle} SetToggle={(bool) => setToggle(bool)}>
                <div className="col">
                    <Input<TrenDAP.iTemplatableWidget<TrenDAP.iTemplatableText>> Field='Label' Record={record} Type='text' Setter={(r) => setRecord(new Text(r))} Valid={(field) => true} />
