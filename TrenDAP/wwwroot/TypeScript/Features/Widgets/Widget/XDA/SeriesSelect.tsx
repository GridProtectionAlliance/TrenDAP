...
export default function SeriesSelect(props: { Widget: Widget<TrenDAP.WidgetClass>, DataSourceID: number, Callback: () => void, Axis?: 'x' | 'y' }) {
    ...
    return (
        <div className="input-group">
            ...
            <select className="form-control" value={selected?.ID ?? '0'} onChange={(evt) => setSelected(dataSource.Data.find(datum => datum.ID === parseInt(evt.target.value)) as TrenDAP.iXDAReturnData)}>
